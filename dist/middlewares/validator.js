...
export const UserValidators = (userRepository) => {
    ...
    const registerValidator = [
        ...
        body('email')
            ...
            const existingUser = yield userRepository.findUserByEmailOrNickname({
                email,
            });
            if (existingUser) {
        ...
        body('nickname')
            ...
            .custom((nickname) => __awaiter(void 0, void 0, void 0, function* () {
            const existingUser = yield userRepository.findUserByEmailOrNickname({
                nickname,
            });
            if (existingUser) {
