-- CreateEnum
CREATE TYPE "Category" AS ENUM ('FASHION', 'BEAUTY', 'SPORTS', 'ELECTRONICS', 'HOME_INTERIOR', 'HOUSEHOLD_SUPPLIES', 'KITCHENWARE', 'MOBILE_TABLET', 'GAME', 'LUXURY_GOODS', 'INFANT_CHILD', 'PET_SUPPLIES', 'HOBBY', 'BOOKS_MUSIC_STATIONERY', 'TICKET_COUPON', 'USED_CAR', 'MOTORCYCLE', 'TOOLS_INDUSTRIAL_SUPPLIES', 'FREE_SHARING');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('ON_SALE', 'RESERVED', 'COMPLETE');
